...
\pagestyle{fancy}
\lhead{11/03/2022}
\chead{\bf\LARGE Homework 5}
\rhead{Yu-Kai Wang\\Matthew Uryga\\CSCI-4963\\Fall 2022}
\cfoot{\thepage}
\headsep 5mm
...
Layer & Calculation & Bias & Total\\
\hline\hline
conv1 & $3*96*11^2$ & 96 & 34,944\\
conv2 & $96*256*5^2$ & 256 & 614,656\\
conv3 & $256*384*3^2$ & 384 & 885,120\\
conv4 & $384*256*3^2$ & 256 & 884,992\\
conv5 & $256*128*3^2$ & 128 & 295,040\\
linear1 & $6912*1024$ & 1024 & 7,078,912\\
linear2 & $1024*1024$ & 1024 & 1,049,600\\
linear3 & $1024*11$ & 11 & 11,275\\
&&&\\
Total & & & 10,854,539
\end{tabular}

\section{CIFAR10 Accuracy Improvements}
A variety of techniques were used to improve the CIFAR10 accuracy.  First, more convolutional neural network layers were added, and batch norms were applied throughout to help stablize the model and improve accuracy.  Additionally, dropout layers were added to help mitigate the effects of overfitting to the training dataset.  Data augmentation was also used - in this case, random horizontal flip was utilized to augment the dataset.

\section{A Note on Testing Script}
When testing this script, we ran into some issues with the cluster - namely a permissions issue with execve().  We were not able to resolve it in time for submission, and as such, this script is largely untested.  It should work, but if there are any issues, this is likely why.

Instructions for tester.py:
Set file directories on lines 15 and 16 for the images and the labels - sample paths are preset.
> py tester.py

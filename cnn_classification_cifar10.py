...
if __name__ == '__main__':
    ...
    train_transforms = torchvision.transforms.Compose([torchvision.transforms.ToTensor(), h_flip, normalize])
    ...
    network = CNN_small(in_dim=input_dim, out_dim=out_dim, p_drop = 0.4)
